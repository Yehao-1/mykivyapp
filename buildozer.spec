...
# (str) Package name
package.name = myappdemo

# (str) Package domain (needed for android/ios packaging)
package.domain = org.myappdemo

# (str) Source code where the main.py live
source.dir = .
source.main_script = work2.py
...
requirements = python3,kivy,json,List, Dict
...
p4a.source_dir = /home/lenovo/myapp/.buildozer/android/platform/python-for-android
